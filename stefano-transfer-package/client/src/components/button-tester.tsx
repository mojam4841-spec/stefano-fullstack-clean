...
export default function ButtonTester() {
  ...
  const buttonTests: ButtonTest[] = [
    ...
    {
      id: 'avatar-selection',
      name: 'Avatary - Selekcja',
      description: 'Test przycisków wyboru avatarów',
      testFunction: () => {
        const avatarBtns = document.querySelectorAll('button').length;
        return avatarBtns > 10; // Sprawdza czy są przyciski avatarów
      },
      status: 'pending'
    },
    {
    ...
    },
    {
      ...
      testFunction: () => {
        ...
        return fbLink !== null || igLink !== null;
      },
      status: 'pending'
    },
    {
